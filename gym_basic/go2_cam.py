...
def create_robot_actor(sim, env, fixed=True, dof_print=False):
    ...
    return robot_actor, dof_props, dof_states, dof_positions, speeds, egocentric_cam_handle, egocentric_cam_transform
...
if __name__ == "__main__":
    ...
    robot_actor, dof_props, dof_states, dof_positions, speeds, egocentric_cam_handle, egocentric_cam_transform = create_robot_actor(sim, env, dof_print=False, fixed=True)
